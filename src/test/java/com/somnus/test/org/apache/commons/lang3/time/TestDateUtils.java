package com.somnus.test.org.apache.commons.lang3.time;
...
public class TestDateUtils {
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println(DateUtils.parseDate("2013.1.10", "yyyy.MM.dd"));

		Date d = DateUtils.parseDate("2013.1.10", "yyyy.MM.dd");

		System.out.println(new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").format(d));
		
		
		System.out.println(DateUtils.parseDate("2014-06-01", "yyyy-MM-dd"));
	}
