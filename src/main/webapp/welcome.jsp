...
<body style="padding:10px">
	...
	v20131118
	<ul>
		<li>补上资源管理中漏掉的target字段</li>
	</ul>
	<hr />
	v20131116
	<ul>
		<li>更新了最新稳定版JAR包</li>
		<li>为菜单添加了target字段</li>
	</ul>
	<hr />
	v20131115
	<ul>
		<li>扩展了combobox/combogrid的onShowPanel事件，在自动补全模式的时候，可以为初始化数据提供信息</li>
	</ul>
	<hr />
	v20131107
	<ul>
		<li>更新了所有jar包到最新稳定版</li>
	</ul>
	<hr />
	v20131031
	<ul>
		<li>增加了一个JSONP的示例，用于演示AJAX跨域请求</li>
	</ul>
	<hr />
	v20131030
	<ul>
		<li>优化项目代码，更多程度的利用apache的工具类</li>
	</ul>
	<hr />
	v20131029
	<ul>
		<li>优化了File404Filter工具类</li>
		<li>修复了新增机构，不能在用户管理中看到的BUG</li>
	</ul>
	<hr />
	v20131023
	<ul>
